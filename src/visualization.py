...
class Visualizer:
    ...
    def plot_displacement_contour(self, xi, yi, zi, title, filename, displacement_type='位移', unit='mm',
        ...
        ax.set_xlabel('X 坐标 (m)', fontproperties=self.chinese_font)
        ax.set_ylabel('Y 坐标 (m)', fontproperties=self.chinese_font)
        ax.set_title(f'地表{displacement_type}云图 - {title}', fontproperties=self.chinese_font)
        ax.set_aspect('equal')
        divider = make_axes_locatable(ax)
        cax = divider.append_axes("right", size="5%", pad=0.1)
        cbar = plt.colorbar(contour, cax=cax)
        cbar.set_label(f'{displacement_type} ({unit})', fontproperties=self.chinese_font)
    ...
    def plot_tilt_contour(self, xi, yi, tilt_x, tilt_y, filename,
        ...
        ax1.set_xlabel('X 坐标 (m)', fontproperties=self.chinese_font)
        ax1.set_ylabel('Y 坐标 (m)', fontproperties=self.chinese_font)
        ax1.set_title('X方向倾斜变形', fontproperties=self.chinese_font)
        ax1.set_aspect('equal')
        divider1 = make_axes_locatable(ax1)
        cax1 = divider1.append_axes("right", size="5%", pad=0.1)
        cbar1 = plt.colorbar(contour1, cax=cax1)
        cbar1.set_label('X方向倾斜 (mm/m)', fontproperties=self.chinese_font)
        ...
        ax2.set_xlabel('X 坐标 (m)', fontproperties=self.chinese_font)
        ax2.set_ylabel('Y 坐标 (m)', fontproperties=self.chinese_font)
        ax2.set_title('Y方向倾斜变形', fontproperties=self.chinese_font)
        ax2.set_aspect('equal')
        divider2 = make_axes_locatable(ax2)
        cax2 = divider2.append_axes("right", size="5%", pad=0.1)
        cbar2 = plt.colorbar(contour2, cax=cax2)
        cbar2.set_label('Y方向倾斜 (mm/m)', fontproperties=self.chinese_font)
        plt.tight_layout()
        for fmt in config.SAVE_FORMATS:
            save_path = os.path.join(config.RESULTS_DIR, f'{filename}.{fmt}')
            plt.savefig(save_path, dpi=config.DPI, bbox_inches='tight')
    ...
    def plot_curvature_contour(self, xi, yi, curvature_x, curvature_y, filename,
        ...
        ax1.set_xlabel('X 坐标 (m)', fontproperties=self.chinese_font)
        ax1.set_ylabel('Y 坐标 (m)', fontproperties=self.chinese_font)
        ax1.set_title('X方向曲率', fontproperties=self.chinese_font)
        ax1.set_aspect('equal')
        divider1 = make_axes_locatable(ax1)
        cax1 = divider1.append_axes("right", size="5%", pad=0.1)
        cbar1 = plt.colorbar(contour1, cax=cax1)
        cbar1.set_label('X方向曲率 (10^-3/m)', fontproperties=self.chinese_font)
        ...
        ax2.set_xlabel('X 坐标 (m)', fontproperties=self.chinese_font)
        ax2.set_ylabel('Y 坐标 (m)', fontproperties=self.chinese_font)
        ax2.set_title('Y方向曲率', fontproperties=self.chinese_font)
        ax2.set_aspect('equal')
        divider2 = make_axes_locatable(ax2)
        cax2 = divider2.append_axes("right", size="5%", pad=0.1)
        cbar2 = plt.colorbar(contour2, cax=cax2)
        cbar2.set_label('Y方向曲率 (10^-3/m)', fontproperties=self.chinese_font)
        plt.tight_layout()
        for fmt in config.SAVE_FORMATS:
            save_path = os.path.join(config.RESULTS_DIR, f'{filename}.{fmt}')
            plt.savefig(save_path, dpi=config.DPI, bbox_inches='tight')
    ...
    def plot_strain_contour(self, xi, yi, strain_x, strain_y, shear_strain, filename,
        ...
        ax1.set_xlabel('X 坐标 (m)', fontproperties=self.chinese_font)
        ax1.set_ylabel('Y 坐标 (m)', fontproperties=self.chinese_font)
        ax1.set_title('X方向水平变形', fontproperties=self.chinese_font)
        ax1.set_aspect('equal')
        divider1 = make_axes_locatable(ax1)
        cax1 = divider1.append_axes("right", size="5%", pad=0.1)
        cbar1 = plt.colorbar(contour1, cax=cax1)
        cbar1.set_label('X方向水平变形 (mm/m)', fontproperties=self.chinese_font)
        ...
        ax2.set_xlabel('X 坐标 (m)', fontproperties=self.chinese_font)
        ax2.set_ylabel('Y 坐标 (m)', fontproperties=self.chinese_font)
        ax2.set_title('Y方向水平变形', fontproperties=self.chinese_font)
        ax2.set_aspect('equal')
        divider2 = make_axes_locatable(ax2)
        cax2 = divider2.append_axes("right", size="5%", pad=0.1)
        cbar2 = plt.colorbar(contour2, cax=cax2)
        cbar2.set_label('Y方向水平变形 (mm/m)', fontproperties=self.chinese_font)
        ...
        ax3.set_xlabel('X 坐标 (m)', fontproperties=self.chinese_font)
        ax3.set_ylabel('Y 坐标 (m)', fontproperties=self.chinese_font)
        ax3.set_title('剪切变形', fontproperties=self.chinese_font)
        ax3.set_aspect('equal')
        divider3 = make_axes_locatable(ax3)
        cax3 = divider3.append_axes("right", size="5%", pad=0.1)
        cbar3 = plt.colorbar(contour3, cax=cax3)
        cbar3.set_label('剪切变形 (mm/m)', fontproperties=self.chinese_font)
        plt.tight_layout()
        for fmt in config.SAVE_FORMATS:
            save_path = os.path.join(config.RESULTS_DIR, f'{filename}.{fmt}')
            plt.savefig(save_path, dpi=config.DPI, bbox_inches='tight')
